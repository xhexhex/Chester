...
// Square direction data for each of the 64 squares of the chessboard.
// A square either has or doesn't have another square near it it a particular
// direction. For example, there's a square NORTH of e4 (namely the square e5)
// but there's no square SOUTH of e1. The directions are defined by enum
// sq_direction.
const Bitboard SQ_NAVIGATOR[][ 16 ] = {
